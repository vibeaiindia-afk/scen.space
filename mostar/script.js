...
function setupSightSlider() {
  ...
  // middle one without the viewer seeing an edge
...
function update() {
  ...
  root.style.setProperty("--bazaar-brightness", 1 - frame2.active * 0.255 - frame3.active * 0.06);
  root.style.setProperty("--bazaar-saturation", 1 + frame3.active * 0.18);
  ...
  root.style.setProperty("--bridge-scale", 1.02 + sharedHeroScale + frame2.exit * 0.46);
  ...
  root.style.setProperty("--split-left-scale", 1 + sharedHeroScale + frame2.enter * 0.74);
  ...
  root.style.setProperty("--split-right-scale", 1 + sharedHeroScale + frame2.enter * 0.74);
  ...
  root.style.setProperty("--frame2-scale", 1.06 + frame2.enter * 0.08 + frame2.exit * 0.08);
